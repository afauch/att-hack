...
public class StageSize : MonoBehaviour, IOutputModule {
	...
	void UpdateStageSize(float value) {
		...
		StartCoroutine(LerpHelper.LerpScaleWithEasing(_stage,_stage.transform.localScale,new Vector3 (Mathf.Lerp(0.0f,500.0f,value), 1.0f, Mathf.Lerp(0.0f,500.0f,value)),0.2f,"Linear", false, 0.0f));
